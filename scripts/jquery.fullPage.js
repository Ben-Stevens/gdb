...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        options = $.extend({
            //navigation
            menu: false,
            anchors:['Equipment', 'Step one', 'Step two', 'Step three', 'Step four', 'Step five', 'Step six', 'Step seven', 'Step eight'],
            lockAnchors: false,
            navigation: false,
            navigationPosition: 'right',
            navigationTooltips: ['Equipment', 'Step one', 'Step two', 'Step three', 'Step four', 'Step five', 'Step six', 'Step seven', 'Step eight'],
